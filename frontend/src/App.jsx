    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route path="/make-reservation" element={<ProtectedRoute role="customer"><MakeReservation /></ProtectedRoute>} />
          ...
          <Route path="/superadmin/employees"  element={<ProtectedRoute role="superadmin"><Employees /></ProtectedRoute>} />
          <Route path="/superadmin/customers"  element={<ProtectedRoute role="superadmin"><SuperCustomers /></ProtectedRoute>} />
          <Route path="/superadmin/accounting" element={<ProtectedRoute role="superadmin"><Accounting /></ProtectedRoute>} />
          <Route path="/superadmin/reports"    element={<ProtectedRoute role="superadmin"><SuperReports /></ProtectedRoute>} />
          <Route path="/superadmin/settings"   element={<ProtectedRoute role="superadmin"><SystemSettings /></ProtectedRoute>} />
